  ...
  static String? validateMobileNumber(String? value) {
    ...
    if (value.startsWith('+201')) {
      ...
      if (value.length != expectedLength) {
        return 'Egyptian mobile number must be 13 digits (including +201)';
      }
      ...
      expectedLength = 12;
      if (value.length != expectedLength) {
        return 'Egyptian mobile number must be 12 digits (including 201)';
      }
      ...
      expectedLength = 11;
      if (value.length != expectedLength) {
        return 'Egyptian mobile number must be 11 digits';
      }
    ...
    // Check for valid Egyptian mobile prefixes (0, 1, 2, or 5 after 01)

...
class LanguageSwitcher extends StatelessWidget {
  ...
  Widget _buildTextSwitcher(
    ...
    for (int i = 0; i < languageProvider.languages.length; i++) {
      ...
      final displayText = uppercase ? lang.code.toUpperCase() : lang.code;
      ...
      if (i < languageProvider.languages.length - 1) {
        languageSpans.add(TextSpan(text: divider, style: baseStyle));
      }
    }
    ...
    return Padding(
      ...
      child: RichText(text: TextSpan(children: languageSpans)),
    );
  }
  ...
  Widget _buildButtonSwitcher(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: _buildLanguageItems(context, languageProvider, currentLang, (
          context,
          lang,
          isSelected,
          displayText,
  ...
  List<Widget> _buildLanguageItems<T>(
    ...
    for (int i = 0; i < languageProvider.languages.length; i++) {
      ...
      if (i < languageProvider.languages.length - 1 &&
          mode == LanguageSwitcherMode.buttons) {

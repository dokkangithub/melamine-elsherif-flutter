...
class CategoryCacheManager {
  ...
  static const String _filterPageCategoriesKey =
      'cached_filter_page_categories';
  ...
  static Future<CategoryResponseModel?> getCategories({
    String? parentId,
  }) async {
    final prefs = await SharedPreferences.getInstance();
    String key = parentId != null
  ...
  static Future<void> saveFeaturedCategories(CategoryResponseModel data) async {
    ...
    await prefs.setInt(
      '$_featuredCategoriesKey$_timestampSuffix',
      DateTime.now().millisecondsSinceEpoch,
    );
  }
  ...
  static Future<CategoryResponseModel?> getFeaturedCategories() async {
    ...
    final int? timestamp = prefs.getInt(
      '$_featuredCategoriesKey$_timestampSuffix',
    );
  ...
  static Future<void> saveTopCategories(CategoryResponseModel data) async {
    ...
    await prefs.setInt(
      '$_topCategoriesKey$_timestampSuffix',
      DateTime.now().millisecondsSinceEpoch,
    );
  }
  ...
  static Future<void> saveFilterPageCategories(
    CategoryResponseModel data,
  ) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString(_filterPageCategoriesKey, jsonEncode(data.toJson()));
    await prefs.setInt(
      '$_filterPageCategoriesKey$_timestampSuffix',
      DateTime.now().millisecondsSinceEpoch,
    );
  }
  ...
  static Future<CategoryResponseModel?> getSubCategories(
    String mainCategoryId,
  ) async {
    final prefs = await SharedPreferences.getInstance();
    final String key = _subCategoriesKeyPrefix + mainCategoryId;
